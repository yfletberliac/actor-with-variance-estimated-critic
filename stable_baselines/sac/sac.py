...
from stable_baselines.common.base_class import OffPolicyRLModel, SetVerbosity, TensorboardWriter
from stable_baselines.common.vec_env import VecEnv
from stable_baselines.common.math_util import unscale_action, scale_action
from stable_baselines.sac.utils import ReplayBuffer
...
class SAC(OffPolicyRLModel):
    ...
    def __init__(self, policy, env, gamma=0.98, learning_rate=3e-4, buffer_size=1000000,
                 learning_starts=10000, train_freq=1, batch_size=256, value_coef=1.0,
                 tau=0.01, ent_coef='auto', target_update_interval=1, avec_coef=1.0,
