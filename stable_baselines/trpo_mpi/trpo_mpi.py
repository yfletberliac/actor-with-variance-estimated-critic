...
from stable_baselines.trpo_mpi.utils import traj_segment_generator, add_vtarg_and_adv, flatten_lists, conjugate_gradient
from stable_baselines.common import explained_variance_tensor, variance_tensor
...
class TRPO(ActorCriticRLModel):
    ...
    """
    def __init__(self, policy, env, gamma=0.99, timesteps_per_batch=2048, max_kl=0.01, cg_iters=20, lam=.95,
                 entcoeff=0.0, cg_damping=0.00086, vf_stepsize=0.0014, vf_iters=10, verbose=0, tensorboard_log=None,
                 _init_setup_model=True, policy_kwargs=None, full_tensorboard_log=False, avec_coef=1.0, vf_coef=1.0,
    ...
    def setup_model(self):
        ...
        from stable_baselines.trpo_mpi.utils import TransitionClassifier
